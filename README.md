...
- [PostCSS](https://postcss.org), used mainly for:
	- [Tailwind CSS](https://tailwindcss.com). You&rsquo;ll still see vestiges of pre-Tailwind CSS here and there in the site&mdash;it was formerly based on [SCSS](https://sass-lang.com/documentation/syntax) and [CSS Grid](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout)&mdash;but, for the most part, this is now a [utility-first CSS](https://frontstuff.io/in-defense-of-utility-first-css) site.
	- [PurgeCSS](https://www.purgecss.com)&mdash;Without this, you **really** don&rsquo;t want to use Tailwind. My dev-mode CSS file is 2.5&nbsp;**MB** (much of which, to be fair to Tailwind since it [shouldn&rsquo;t be nearly that big on its own](https://tailwindcss.com/docs/controlling-file-size/), is due to those Web &ldquo;fonts&rdquo;); but, in production, especially after [Netlify](https://netlify.com) GZIPs it, it&rsquo;s only about 7.3&nbsp;**K**. Whoa. *(Even just locally*&mdash;i.e., *without GZIPping happening&mdash;when I&rsquo;m using that `testbuild` script you see mentioned in &ldquo;Scripts in `package.json`,&rdquo; PurgeCSS cuts it down from 2.5&nbsp;MB to about 23&nbsp;KB.)* PurgeCSS is the [bariatric surgeon](https://en.wikipedia.org/wiki/Bariatric_surgery) of CSS.
