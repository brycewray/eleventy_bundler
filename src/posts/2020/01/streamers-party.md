...
Incidentally, this was all prior to the "cable box" era, at least where I lived. Back then, the signal came through an adapter that connected directly to your TV. Only years later, in the early 1990s, did I first have a setup which had a cable box. Of course, the purpose of this box *wasn't* to give you anything more, other than another remote control to keep out of the hands of one's rug rat(s); it was to *encode* channels, to make sure you couldn't see or even hear channels to which you weren't a subscriber. (Unfortunately, it also made using one's [VCR](https://en.wikipedia.org/wiki/Videocassette_recorder) more of a hassle; but that's another story for another time.)
