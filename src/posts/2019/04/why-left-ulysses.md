...
{% lazypicture "Ulysses_export_to_Markdown", "png", 750, "Screen capture of Quick Export feature of Ulysses app" %}
<p class="legal ctr">Ulysses’s Quick Export feature: the only way you can derive a true, standalone, visible Markdown&nbsp;file from one of its native, proprietary-format&nbsp;files.</p>
...
{% lazypicture "iCloud_sync-save_icon_in_Ulysses", "png", 634, "Screen capture from Ulysses showing iCloud icon, indicating ongoing sync" %}
<p class="ctr legal">When this little cloud icon (highlighted in the yellow circle) just sits and sits and sits in the Ulysses sheet synopsis and the timestamp doesn&rsquo;t change, even though you edited this file days ago on another device—Houston, we have an iCloud&nbsp;sync&nbsp;problem.</p>
...
{% lazypicture "iA_Writer_on_why-left-ulysses_post", "png", 2766, "Screen capture from iA Writer app" %}
<p class="ctr legal">Ladies and gentlemen, the winner (for now): iA&nbsp;Writer.</p>
