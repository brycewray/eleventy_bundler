...
featured_image: /assets/images/hand-butterfly-3751159_blue-tinted_monochrome_1280x720_60pct.jpg
...
{{< figure src="/assets/images/Ulysses_export_to_Markdown.png" caption="Ulysses's Quick Export feature: the only way you can derive a true, standalone, visible Markdown&nbsp;file from one of its native, proprietary-format&nbsp;files." alt="Screen capture of Quick Export feature of Ulysses app" >}}
...
{{< figure src="/assets/images/iA_Writer_on_why-left-ulysses_post.png" caption="Ladies and gentlemen, the winner (for now): iA&nbsp;Writer." alt="Screen capture from iA Writer app" >}}
